ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :volunteer_offerings
  ...
  map.resources :volunteer_tasks

  map.resources :wholesale_orders

  map.resources :member_product_request_joins

  map.resources :comments

  map.resources :product_requests
